...
void Rgemm(const char *transa, const char *transb, long const m, long const n, long const k, double const alpha, double *a, long const lda, double *b, long const ldb, double const beta, double *c, long const ldc) {
